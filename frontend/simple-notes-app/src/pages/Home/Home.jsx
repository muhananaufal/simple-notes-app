...
function Home() {
	...
	const updateIsPinned = async (noteData) => {
		...
		try {
			const response = await axiosInstance.put('/update-note-pinned/' + noteId, { isPinned: !noteId.isPinned });
	...
	return (
		<>
			<Navbar userInfo={userInfo} onSearchNote={onSearchNote} handlerClearSearch={handlerClearSearch} />
			...
			<ToastMessage isShown={showToastMsg.isShown} message={showToastMsg.message} type={showToastMsg.type} onClose={handleCloseToast} />
		</>
	);
}
